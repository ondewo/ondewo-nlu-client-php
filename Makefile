...
#
# The ONDEWO NLU (Natural Language Understanding) gRPC client for PHP. There is no hand-written
# transport layer here: the whole client surface is generated from the .proto definitions of
# ondewo-nlu-api by the ondewo-proto-compiler's `ondewo-php-proto-compiler` image, and the
